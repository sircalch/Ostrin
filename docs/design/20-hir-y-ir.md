...
`Array<T>` numérico escalar también cruza la frontera como parámetro: la indexación
unidimensional usa el runtime C generado (`Array_Float_index1`, `Array_Int_index1`,
`Array_Float32_index1` o `Array_Bool_index1`) y conserva retain/release del array.

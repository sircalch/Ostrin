...
export const GALLERY = [
  ...
  { id: "linked-data", title: "Linked data selection", file: "examples/viz_linked_data.ostrin", blurb: "The same Ostrin samples feed a scatter plot and a table; click either side to select the matching row." },

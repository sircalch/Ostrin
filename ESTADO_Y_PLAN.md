...
Agregados complejos, iteradores propios, patrones distintos de `Some/None` y payloads gestionados
que no sean `String` caen de forma verificable a HIR y después al AST.

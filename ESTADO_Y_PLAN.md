...
actual, la suite de ejemplos suma 979 funciones IR, 457 HIR y 1 369 que aún caen al emisor
AST; `native_backend_types_agree_with_the_checker` mantiene 1 369 como trinquete y debe bajar
...
(ya consume los tipos del checker y compara cada nodo; el informe actual suma **979 funciones
generadas desde IR, 457 desde HIR y 1 369 en fallback AST** en los ejemplos, con un trinquete

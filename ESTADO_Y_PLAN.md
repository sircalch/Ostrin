...
*Corte: 2026-09-21 · rama `main` · 6 pruebas diferenciales, 184 de integración y 2 unitarias en verde.*
...
- `spawn`/`join`/`cancel`/`yield`/`spawn_scope`/canales con scheduler cooperativo determinista por defecto, igual

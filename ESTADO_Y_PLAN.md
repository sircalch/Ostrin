...
| Visualización | `std.viz` 0.1 (documento 23): marcas 2D, heatmap/contornos, superficies/trayectorias/nubes 3D, layouts y ejes con unidades, SVG determinista idéntico en intérprete, nativo y WASM. Pendiente: interacción, animación, PNG/PDF, WebGPU; el emisor HIR aún pierde memoria de concatenaciones de `String` anidadas al construir SVG grandes (la salida es correcta) |
